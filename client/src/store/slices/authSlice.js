...
export const register = (data) => async (dispatch) => {
    ...
    await axios.post(`${API}/api/v1/auth/register`, data, {
...
export const otpVerification = (email, otp) => async (dispatch) => {
    ...
    await axios.post(`${API}/api/v1/auth/verify-otp`, { email, otp }, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json"
        },
...
export const login = (data) => async (dispatch) => {
    ...
    await axios.post(`${API}/api/v1/auth/login`, data, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json"
        },
...
export const resetPassword = (data, token) => async (dispatch) => {
    ...
    await axios.put(`${API}/api/v1/auth/password/reset/${token}`, data, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json"
        },
...
export const updatePassword = (data) => async (dispatch) => {
    ...
    await axios.put(`${API}/api/v1/auth/password/update`, data, {
        withCredentials: true,
        headers: {
            "Content-Type": "application/json"
        },
