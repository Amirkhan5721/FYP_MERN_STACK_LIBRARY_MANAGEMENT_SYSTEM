...
export const recordBorrowBook = (email, id) => async (dispatch) => {
    ...
    await axios
        .post(`http://localhost:4000/api/v1/borrow/record-borrow-book/${id}`,
            { email },
            {
                withCredentials: true,
                headers: {
        ...
        .catch((err) => {
            dispatch(borrowSlice.actions.recordBookFailed(
                err.response.data.message));
        })
}
...
export const returnBook = (email, id) => async (dispatch) => {
    ...
    await axios
        .put(`http://localhost:4000/api/v1/borrow/return-borrowed-book/${id}`,
            { email },
            {
                withCredentials: true,
                headers: {
